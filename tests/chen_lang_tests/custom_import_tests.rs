...
fn test_import_custom_module_simple() {
    let source = r#"
        ...
        let mod = import "tests/chen_lang_tests/modules/temp_module.ch"
        io.println(mod.name)
...
fn test_import_custom_module_caching() {
    let source = r#"
        let m1 = import "tests/chen_lang_tests/modules/cached_module.ch"
        let m2 = import "tests/chen_lang_tests/modules/cached_module.ch"
    "#;
